...
\begin{itemize}
  \item \textbf{PID} exhibited the largest $|e|_{\text{RMS}}$, especially
  ...
  \item \textbf{MPPI} outperformed PID by virtue of horizon-aware planning. On analysis of the cost over time plot, MPPI showed the greatest gains over PID through the center of the figure eight, where there is a rapid change in steering from left to right that rewards prior planning.
