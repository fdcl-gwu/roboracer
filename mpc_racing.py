...
#!/usr/bin/env python3
"""
mpc_racing.py — Nonlinear MPC (acados + CasADi, NONLINEAR_LS cost)
...
STEER_CENTER = 512
STEER_TRIM   = 20
STEER_GAIN   = 900  # servo units per radian of steering angle
...
W_SPEED      =  0.1   # low: deemphasise speed — the external FF+PI throttle loop handles it
W_DELTA      =  0.75   # pull toward curvature-implied delta_ref (feedforward steering)
W_DELTA_e    =  0.005   # terminal: penalty on residual delta — keeps unwind planned
W_DELTA_RATE =  0.009   # damping: prevents δ chatter when heading penalty drives aggressive corrections
W_ACCEL      =  0.1
